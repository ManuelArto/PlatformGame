...
public:
    HardEnemy(int x, int y, int points=30, int life=30, int attack=30, double cooldown_shoot=1.2, double cooldown_movement=0.8, char *symbol=(char *)"H", char *mir_symbol=(char *)"H");
