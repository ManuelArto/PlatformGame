...
public:
    ...
    void movement(int player_x, int player_y, double time, bool hasPlatformAbove, bool hasPlatformBelow, int width, int height, bool hasPlatformRight, bool hasPlatformLeft);
};
