...
public:
    MediumEnemy(int x, int y, int level, int point=100, int life=40, int attack=20, double cooldown_shoot=0.5, double cooldown_movement=1.0, double min_distance_shoot=30, char *symbol=(char *)"M");
