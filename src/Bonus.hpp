...
private:
	...
	bonus_type type;
public:
	Bonus(int x, int y, bonus_type type, int bonus_life=50, int bonus_points=50, double minigun_cooldown=0.2, double minigun_timer=5.0, double invincibility_timer=5.0);
