...
public:
    HardEnemy(int x, int y, int points=30, int life=30, int attack=30, double cooldown_shoot=1.2, double cooldown_movement=0.5, double min_distance_shoot=30, char *symbol=(char *)"H");
